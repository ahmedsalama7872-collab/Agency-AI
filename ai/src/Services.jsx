...
export default function Services({ dark }) {
  ...
  return (
    <div
      ...
      lg:px-24 sm:px-10 text-gray-700 dark:text-white"
    >
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-14 mt-16 w-[100%] lg:w-[85%]">
        ...
        <div className="w-[100%] flex h-[180px] p-2 sm:p-8 gap-5 bg-white rounded-2xl dark:bg-gray-900 relative items-center group">
          ...
          <div className="text-black dark:text-white flex flex-col gap-3.5">
        ...
        <div className="w-[100%] flex h-[180px] p-2 sm:p-8 gap-5 bg-white rounded-2xl dark:bg-gray-900 relative items-center group">
          ...
          <div className="text-black dark:text-white flex flex-col gap-3.5">
            <h3 className="font-bold">Content marketing</h3>
            <p>
              We turn bold ideas into powerful digital solutions that connect,
              engage...
            </p>
