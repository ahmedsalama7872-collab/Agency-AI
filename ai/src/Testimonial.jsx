...
brand’s success.
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 mt-16 w-[120%] lg:w-[85%]'>
...
hover:scale-103 transition-all duration-400'>
        <div className='w-1/8 md:w-1/4'><img src={data.image} alt="" className='rounded-full'/></div>
