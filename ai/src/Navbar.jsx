      ...
      transition={{duration:0.6,ease:'easeOut'}} className="fixed top-0 left-0 w-full h-18 bg-white dark:bg-gray-900 z-50">
        <div className="w-[90%] container mx-auto max-w-[1450px] h-full flex items-center justify-between">
          ...
          <div className="w-[342px] justify-between main-text hidden lg:flex">
            <a href="#home" className="hover:border-b">
              Home
            </a>
            <a href="#services" className="hover:border-b">
              Services
            </a>
            <a href="#ourWorks" className="hover:border-b">
              Our Work
            </a>
            <a href="#testimonial" className="hover:border-b">
              Testimonial
            </a>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-10">
            <div
              ...
              className="hover:scale-105 rounded-full border-[1.5px] border-[#475569] flex justify-center items-center p-2"
            >
              <button>
            ...
            <a
              href="#contact"
              className="w-[160px] h-[46px] rounded-[33px] primaryBg !text-white hover:scale-[1.03] transition-all flex items-center justify-center"
            >
              Connect{" "}
